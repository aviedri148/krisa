        ...
        <section id="causes" class="py-16 bg-slate-50 rounded-lg">
            ...
            <div class="tab-content" id="logistics">
                <div class="bg-white p-8 rounded-lg shadow-inner">
                    ...
                    <p class="mb-4">הבחירה בשדה התעופה הקטן בבקאו, רומניה, לא התאימה להיקף של 65 טיסות ואלפי נוסעים. למרות שהוצגה תכנית עבודה, היא קרסה תחת העומס. התכנית התבססה על הכנסת קבוצות קטנות של 50 איש בכל פעם, מה שלא עבד בפועל. בנוסף, ההחלטה להמשיך לשלוח אוטובוסים מאומן לגבולות שכבר היו פקוקים החמירה את המצב, מתוך תקווה שהבעיה תיפתר "כל רגע".</p>
                </div>
            </div>
                 ...
                 <div class="bg-white p-8 rounded-lg shadow-inner">
                    ...
                    <div class="flex flex-col md:flex-row justify-around items-center text-center gap-4">
                        <div class="flex-1 p-4 border rounded-lg">
                             ...
                             <p>מנעה כניסת ישראלים בתירוץ של חוב ישראלי בסך כ-700,000 ש"ח. ההחלטה סגרה נתיב מרכזי והפנתה את כל העומס לרומניה.</p>
                        </div>
                        ...
                        <div class="flex-1 p-4 border rounded-lg bg-blue-50">
                             ...
                             <p>התנהלות בירוקרטית איטית בעיכוב תשלומים וחוסר מעורבות מוקדמת תרמו להסלמת המצב מול מולדובה ואוקראינה.</p>
                        </div>
                         <div class="text-4xl text-slate-400 font-light mx-4">&harr;</div>
                        <div class="flex-1 p-4 border rounded-lg">
                             <h5 class="font-bold text-lg text-yellow-600">אוקראינה</h5>
                             <p>בעבר, אי-שיתוף פעולה נבע מעיכוב סיוע ישראלי בסך 40 מיליון ש"ח. המצב מראה דפוס חוזר של שימוש בקיבוץ באומן כמנוף לחץ.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 items-center">
                <div>
                    <div class="grid grid-cols-2 gap-4 text-center">
                       <div class="bg-white p-4 rounded-lg shadow-lg">
                            ...
                            <p class="text-slate-600">ביטולי טיסות חזור</p>
                        </div>
                         <div class="bg-white p-4 rounded-lg shadow-lg">
                            <p class="text-3xl font-bold text-blue-600">65</p>
                            <p class="text-slate-600">טיסות משדה קטן אחד</p>
                        </div>
                        <div class="bg-white p-4 rounded-lg shadow-lg">
                            <p class="text-3xl font-bold text-blue-600">₪700,000</p>
                            <p class="text-slate-600">החוב הנטען למולדובה</p>
                        </div>
                         <div class="bg-white p-4 rounded-lg shadow-lg">
                            <p class="text-3xl font-bold text-blue-600">24+</p>
                            <p class="text-slate-600">שעות המתנה בגבולות</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <div class="chart-container">
                     ...
                     <p class="text-xs text-center text-slate-500 mt-2">הערכה המבוססת על דגשים בשיח</p>
                </div>
                 <div class="bg-white p-6 rounded-lg shadow-lg col-span-1 md:col-span-2">
                    ...
                    <p class="text-center text-slate-600 mt-4">הניסיון להשתמש ברכבות כפתרון נתקל בפער עצום בין הביקוש (עשרות אלפים) לבין ההיצע המוגבל (כ-3,600 מקומות ביום במקרה הטוב).</p>
                </div>
            </div>
        </section>
            ...
            <ul class="space-y-4 max-w-2xl mx-auto">
                <li class="bg-white p-4 rounded-lg shadow-sm flex items-start space-x-4 space-x-reverse">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600">הושקעו זמן וכסף רבים בבחינת הפעלת רכבות ייעודיות מפולין. היוזמה נכשלה עקב בירוקרטיה, עלויות גבוהות וקיבולת נמוכה מדי.</p>
                    </div>
                </li>
                 <li class="bg-white p-4 rounded-lg shadow-sm flex items-start space-x-4 space-x-reverse">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600">ניסיונות הידברות עם המשטרה והרשויות ברומניה ובגבולות כדי לשחרר את הפקקים, לרוב ללא הצלחה משמעותית.</p>
                    </div>
                </li>
                <li class="bg-white p-4 rounded-lg shadow-sm flex items-start space-x-4 space-x-reverse">
                    <span class="text-blue-500 text-2xl font-bold">🎫</span>
                    <div>
                        ...
                        <p class="text-slate-600">הסוכנים עבדו מסביב לשעון כדי למצוא מקומות חלופיים לאלפי הנוסעים שטיסותיהם בוטלו ולשבץ אותם בטיסות קיימות.</p>
                    </div>
                </li>
                 <li class="bg-white p-4 rounded-lg shadow-sm flex items-start space-x-4 space-x-reverse">
                    <span class="text-blue-500 text-2xl font-bold">❤️</span>
                    <div>
                        <h4 class="font-semibold">סיוע אזרחי בשטח</h4>
                        <p class="text-slate-600">התארגנויות פרטיות דאגו לאספקת מזון ומים לאנשים התקועים, ונציגים ניסו לסייע בהכנסת מקרים דחופים כמו קשישים וילדים.</p>
                    </div>
                </li>
            </ul>
        </section>
        ...
        <section id="lessons" class="py-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div class="bg-blue-50 p-6 rounded-lg border-r-4 border-blue-500">
                    ...
                    <p>יש לפעול כדי שהקיבוץ באומן לא יהפוך לקלף מיקוח פוליטי בין מדינות. יש צורך בניתוק האירוע מהדיפלומטיה.</p>
                </div>
                <div class="bg-blue-50 p-6 rounded-lg border-r-4 border-blue-500">
                    <h4 class="font-bold text-lg mb-2">היערכות מוקדמת וריאלית</h4>
                    <p>התכנון לשנים הבאות חייב להתחיל מוקדם הרבה יותר, תוך בחינת כל התרחישים ובחירת נתיבים ושדות תעופה שיכולים לעמוד בעומס.</p>
                </div>
                 <div class="bg-blue-50 p-6 rounded-lg border-r-4 border-blue-500">
                    <h4 class="font-bold text-lg mb-2">ניהול מרכזי ותקשורת</h4>
                    <p>יש לשקול הקמת גוף ניהול מתכלל שיוכל לספק מידע אמין לציבור ולתאם בין כל הגורמים בשטח בזמן אמת.</p>
                </div>
                <div class="bg-blue-50 p-6 rounded-lg border-r-4 border-blue-500">
                    <h4 class="font-bold text-lg mb-2">שיתוף פעולה עם הציבור</h4>
                    <p>פתיחת ערוץ לקבלת רעיונות ופתרונות מהציבור, שיכול לתרום מניסיונו וחוכמתו לשיפור המערך כולו.</p>
                </div>
            </div>
        </section>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            new Chart(issuesCtx, {
                type: 'doughnut',
                data: {
                    labels: ['תקיעות בגבולות', 'ביטולי טיסות', 'סבך פוליטי', 'תשתיות לקויות'],
                    datasets: [{
                        label: 'חלוקת הבעיות',
                        data: [35, 30, 20, 15],
                        backgroundColor: [
